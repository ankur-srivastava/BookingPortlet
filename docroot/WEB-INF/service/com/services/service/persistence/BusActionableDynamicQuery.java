 ...
 * @generated
 */
public abstract class BusActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public BusActionableDynamicQuery() throws SystemException {
		setBaseLocalService(BusLocalServiceUtil.getService());
		setClass(Bus.class);

		setClassLoader(com.services.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("busId");
	}
}