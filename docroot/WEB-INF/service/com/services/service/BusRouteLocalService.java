...
/**
 * Provides the local service interface for BusRoute. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ankur Srivastava
 * @see BusRouteLocalServiceUtil
...
public interface BusRouteLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BusRouteLocalServiceUtil} to access the bus route local service. Add custom service methods to {@link com.services.service.impl.BusRouteLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
